...
```javascript
iterFlatTopPulse = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-flat-top-pulse@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-flat-top-pulse@v0.2.1-umd/browser.js"></script>
```
